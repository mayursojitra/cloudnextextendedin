  ...
  <v-container fluid>
    <v-row justify="start" align="start">
      <v-col cols="12" md="12" lg="12" xl="12">
        ...
        >If you witness any attendee breaching the code of conduct, please reach out to us at <a href="mailto:cloudnextgdgwest@gmail.com" :class="$vuetify.theme.dark == true ? 'white--text' : 'grey--text text--darken-4'"> cloudnextgdgwest@gmail.com</a>.</p>
      </v-col>
    </v-row>
  </v-container>
</template>
