  ...
  <v-content class="ma-0">
    <v-container>
      <v-row justify="center" align="center">
        <v-col md="10" xl="10" sm="10" cols="12" class="text-center">
          <br />
          <v-img
            :src="require('@/assets/img/cloudnextlogo.png')"
          ...
          >Google Cloud Next Extended'20: Registration</p>
          <p
            class="google-font"
            :class="
              this.$vuetify.theme.dark
            ...
            v-if="!formSubmitted"
          >Cloud Next On AirExtended 2020, and Yes, We Can't Believe How Many Words that is Either</p>
          <v-divider></v-divider>

          <p class="google-font mt-4" v-if="!formSubmitted" style="font-size:110%">
            Connect with us at
            <a
              href="https://twitter.com/GDGCloudAhm"
              rel="noreferrer"
              target="_blank"
              style="text-decoration:none;"
            >@GDGCloudAhm</a> for the
            latest updates.
            <br />For any query, contact us at:
            <a
              href="mailto:cloudnextgdgwest@gmail.com"
              style="text-decoration:none"
              :class="$vuetify.theme.dark == true ? 'white--text' : 'primary--text'"
            >cloudnextgdgwest@gmail.com</a>
          </p>
        ...
        <v-col md="12" sm="11" xl="10" cols="12" v-if="!formSubmitted">
          ...
          .length === 4"
                  ...
                  <v-checkbox
                    ...
                    name="entry.1536285773"
                    v-on:change="validateForm()"
                    v-model="userInfo.themeCheckbox[4]"
                  ...
                  <v-checkbox
                    ...
                    name="entry.1536285773"
                    v-on:change="validateForm()"
                    v-model="userInfo.themeCheckbox[5]"
                    label="Data Management & Databases"
                    value="Data Management & Databases"
                  ></v-checkbox>
                  <v-checkbox
                    class="my-0"
                    name="entry.1536285773"
                    v-on:change="validateForm()"
                    v-model="userInfo.themeCheckbox[6]"
                  ...
                  <v-checkbox
                    ...
                    name="entry.1536285773"
                    v-on:change="validateForm()"
                    v-model="userInfo.themeCheckbox[7]"
                    label="Cloud AI"
                    value="Cloud AI"
                  ></v-checkbox>
                  <v-checkbox
                    ...
                    name="entry.1536285773"
                    v-on:change="validateForm()"
                    v-model="userInfo.themeCheckbox[8]"
                    label="Business Application Platform"
                    value="Business Application Platform"
                  ></v-checkbox>
                </v-col>
              </v-row>
              <v-row justify="center" align="center">
        ...
        >
          <h1 class="google-font">Cloud Next On AirExtended 2020, and Yes, We Can't Believe How Many Words that is Either</h1>
          <br />
...
export default {
  ...
  methods: {
    ...
    response() {
      ...
      let url =
        "https://cors-anywhere.herokuapp.com/https://docs.google.com/forms/u/6/d/e/1FAIpQLSft6zQ1RtWxuDnd637Qr-du12eJGzW-48TVkFNh0IF_gkRHxQ/formResponse";
